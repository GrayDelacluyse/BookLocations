...
namespace BookLocations.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult  BookLocation(string Author, string Title)
        {
            ...
            ViewBag.stuff = oclcSearchResult;
            ...
            {
                //Failed
                ViewBag.Message = "Failed to find OCLC Number from search result";
                return View();
            }
            oclcNumberStart += 13;
            ...
            {
                ViewBag.Message = "Failed to find OCLC Number End from search result";
                return View();
            }
            ...
            {
                ViewBag.Message = "Failed to find webservice ID from details page";
                return View();
            }
            ...
            {
                ViewBag.Message = "Failed to find webservice ID End from details page";
                return View();
            }
